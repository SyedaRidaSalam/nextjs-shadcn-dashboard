...
import { BadgeCheck, Candy, Citrus, Shield, SlashIcon } from "lucide-react";
  ...
  const { username } = await params
    return (
      ...
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <BreadcrumbPage className="capitalize">{username}</BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
      <div className="mt-4 flex flex-col xl:flex-row gap-8 mb-5">
        {/* LEFT */}
